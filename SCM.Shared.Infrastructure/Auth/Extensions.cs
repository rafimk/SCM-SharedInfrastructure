...
using SCM.SharedEnabler.Auth;
using SCM.SharedEnabler.Modules;

namespace SCM.Shared.Infrastructure.Auth;
...
public static class Extensions
{
        ...
        Action<JwtBearerOptions> optionsFactory = null)
    {
        ...
        services.AddSingleton(new AuthOptions.CookieOptions
        {
            HttpOnly = options.Cookie.HttpOnly,
            Secure = options.Cookie.Secure,
            SameSite = options.Cookie.SameSite.ToString().ToLowerInvariant() switch
            {
